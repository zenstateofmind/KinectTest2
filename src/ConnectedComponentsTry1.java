...
public class ConnectedComponentsTry1 extends PApplet {
...
//			System.out.println(lcMapList.get(i) + " "+ "color("+r+", "+g+", "+b+")");
		...
		retImg = createImage(500, 500, RGB);
		for(int i = 0; i < secondPass.length; i++)
		{
			int spLabel = secondPass[i];
